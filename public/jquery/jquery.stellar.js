    ...
    _findBackgrounds: function () {
      ...
      $backgroundElements.each(function () {
        ...
        self.backgrounds.push({
          ...
          startingBackgroundPositionLeft: isNaN(parseInt(backgroundPosition[0], 10))
            ? 0
            : parseInt(backgroundPosition[0], 10),
          startingBackgroundPositionTop: isNaN(parseInt(backgroundPosition[1], 10))
            ? 0
          ...
          parentOffsetTop: parentOffsetTop,
          stellarRatio:
            $this.data('stellar-background-ratio') === undefined ? 1 : $this.data('stellar-background-ratio')
        })
      })
    },
    _reset: function () {
